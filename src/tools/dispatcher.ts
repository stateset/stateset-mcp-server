  ...
  switch (safeRequest.params.name) {
    case 'stateset_create_rma': {
      const result = await client.createRMA(
        schemas.CreateRMAArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    ...
    case 'stateset_create_order': {
      const result = await client.createOrder(
        schemas.CreateOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    ...
    case 'stateset_create_warranty':
      return await client.createWarranty(
        schemas.CreateWarrantyArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_warranty':
      return await client.updateWarranty(
        schemas.UpdateWarrantyArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_shipment': {
      const result = await client.createShipment(
        schemas.CreateShipmentArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    ...
    case 'stateset_create_bill_of_materials':
      return await client.createBillOfMaterials(
        schemas.CreateBillOfMaterialsArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_bill_of_materials':
      return await client.updateBillOfMaterials(
        schemas.UpdateBillOfMaterialsArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_work_order':
      return await client.createWorkOrder(
        schemas.CreateWorkOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_work_order':
      return await client.updateWorkOrder(
        schemas.UpdateWorkOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_manufacturer_order':
      return await client.createManufacturerOrder(
        schemas.CreateManufacturerOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_manufacturer_order':
      return await client.updateManufacturerOrder(
        schemas.UpdateManufacturerOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_purchase_order':
      return await client.createPurchaseOrder(
        schemas.CreatePurchaseOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_purchase_order':
      return await client.updatePurchaseOrder(
        schemas.UpdatePurchaseOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_purchase_order':
      return await client.deletePurchaseOrder(
        schemas.DeletePurchaseOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_get_purchase_order':
      return await client.getPurchaseOrder(
        schemas.GetPurchaseOrderArgsSchema.parse(safeRequest.params.arguments).purchase_order_id,
      );
    case 'stateset_list_purchase_orders':
      return await client.listPurchaseOrders(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_asn':
      return await client.createASN(
        schemas.CreateASNArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_asn':
      return await client.updateASN(
        schemas.UpdateASNArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_asn':
      return await client.deleteASN(
        schemas.DeleteASNArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_get_asn':
      return await client.getASN(
        schemas.GetASNArgsSchema.parse(safeRequest.params.arguments).asn_id,
      );
    case 'stateset_list_asns':
      return await client.listASNs(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_invoice':
      return await client.createInvoice(
        schemas.CreateInvoiceArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_invoice':
      return await client.updateInvoice(
        schemas.UpdateInvoiceArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_payment':
      return await client.createPayment(
        schemas.CreatePaymentArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_payment':
      return await client.updatePayment(
        schemas.UpdatePaymentArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_sales_order':
      return await client.createSalesOrder(
        schemas.CreateSalesOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_sales_order':
      return await client.updateSalesOrder(
        schemas.UpdateSalesOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_fulfillment_order':
      return await client.createFulfillmentOrder(
        schemas.CreateFulfillmentOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_fulfillment_order':
      return await client.updateFulfillmentOrder(
        schemas.UpdateFulfillmentOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_item_receipt':
      return await client.createItemReceipt(
        schemas.CreateItemReceiptArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_item_receipt':
      return await client.updateItemReceipt(
        schemas.UpdateItemReceiptArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_cash_sale':
      return await client.createCashSale(
        schemas.CreateCashSaleArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_cash_sale':
      return await client.updateCashSale(
        schemas.UpdateCashSaleArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_product':
      return await client.createProduct(
        schemas.CreateProductArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_product':
      return await client.updateProduct(
        schemas.UpdateProductArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_inventory':
      return await client.createInventory(
        schemas.CreateInventoryArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_inventory':
      return await client.updateInventory(
        schemas.UpdateInventoryArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_create_customer':
      return await client.createCustomer(
        schemas.CreateCustomerArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_update_customer':
      return await client.updateCustomer(
        schemas.UpdateCustomerArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_rma':
      return await client.deleteRMA(
        schemas.DeleteRMAArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    ...
    case 'stateset_delete_sales_order':
      return await client.deleteSalesOrder(
        schemas.DeleteSalesOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_warranty':
      return await client.deleteWarranty(
        schemas.DeleteWarrantyArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_shipment':
      return await client.deleteShipment(
        schemas.DeleteShipmentArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_bill_of_materials':
      return await client.deleteBillOfMaterials(
        schemas.DeleteBillOfMaterialsArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_work_order':
      return await client.deleteWorkOrder(
        schemas.DeleteWorkOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_manufacturer_order':
      return await client.deleteManufacturerOrder(
        schemas.DeleteManufacturerOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_invoice':
      return await client.deleteInvoice(
        schemas.DeleteInvoiceArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_payment':
      return await client.deletePayment(
        schemas.DeletePaymentArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_fulfillment_order':
      return await client.deleteFulfillmentOrder(
        schemas.DeleteFulfillmentOrderArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_item_receipt':
      return await client.deleteItemReceipt(
        schemas.DeleteItemReceiptArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_cash_sale':
      return await client.deleteCashSale(
        schemas.DeleteCashSaleArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_product':
      return await client.deleteProduct(
        schemas.DeleteProductArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_inventory':
      return await client.deleteInventory(
        schemas.DeleteInventoryArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_delete_customer':
      return await client.deleteCustomer(
        schemas.DeleteCustomerArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_get_rma':
      return await client.getRMA(
        schemas.GetRMAArgsSchema.parse(safeRequest.params.arguments).rma_id,
      );
    case 'stateset_get_order':
      return await client.getOrder(
        schemas.GetOrderArgsSchema.parse(safeRequest.params.arguments).order_id,
      );
    case 'stateset_get_warranty':
      return await client.getWarranty(
        schemas.GetWarrantyArgsSchema.parse(safeRequest.params.arguments).warranty_id,
      );
    case 'stateset_get_shipment':
      return await client.getShipment(
        schemas.GetShipmentArgsSchema.parse(safeRequest.params.arguments).shipment_id,
      );
    case 'stateset_get_bill_of_materials':
      return await client.getBillOfMaterials(
        schemas.GetBillOfMaterialsArgsSchema.parse(safeRequest.params.arguments)
          .bill_of_materials_id,
      );
    case 'stateset_get_work_order':
      return await client.getWorkOrder(
        schemas.GetWorkOrderArgsSchema.parse(safeRequest.params.arguments).work_order_id,
      );
    case 'stateset_get_manufacturer_order':
      return await client.getManufacturerOrder(
        schemas.GetManufacturerOrderArgsSchema.parse(safeRequest.params.arguments)
          .manufacturer_order_id,
      );
    case 'stateset_get_invoice':
      return await client.getInvoice(
        schemas.GetInvoiceArgsSchema.parse(safeRequest.params.arguments).invoice_id,
      );
    case 'stateset_get_payment':
      return await client.getPayment(
        schemas.GetPaymentArgsSchema.parse(safeRequest.params.arguments).payment_id,
      );
    case 'stateset_get_sales_order':
      return await client.getSalesOrder(
        schemas.GetSalesOrderArgsSchema.parse(safeRequest.params.arguments).sales_order_id,
      );
    case 'stateset_get_fulfillment_order':
      return await client.getFulfillmentOrder(
        schemas.GetFulfillmentOrderArgsSchema.parse(safeRequest.params.arguments)
          .fulfillment_order_id,
      );
    case 'stateset_get_item_receipt':
      return await client.getItemReceipt(
        schemas.GetItemReceiptArgsSchema.parse(safeRequest.params.arguments).item_receipt_id,
      );
    case 'stateset_get_cash_sale':
      return await client.getCashSale(
        schemas.GetCashSaleArgsSchema.parse(safeRequest.params.arguments).cash_sale_id,
      );
    case 'stateset_get_product':
      return await client.getProduct(
        schemas.GetProductArgsSchema.parse(safeRequest.params.arguments).product_id,
      );
    case 'stateset_get_inventory':
      return await client.getInventory(
        schemas.GetInventoryArgsSchema.parse(safeRequest.params.arguments).inventory_id,
      );
    case 'stateset_get_customer':
      return await client.getCustomer(
        schemas.GetCustomerArgsSchema.parse(safeRequest.params.arguments).customer_id,
      );

    case 'stateset_list_rmas':
      return await client.listRMAs(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    ...
    case 'stateset_list_sales_orders':
      return await client.listSalesOrders(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_warranties':
      return await client.listWarranties(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_shipments':
      return await client.listShipments(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_fulfillment_orders':
      return await client.listFulfillmentOrders(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_item_receipts':
      return await client.listItemReceipts(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_cash_sales':
      return await client.listCashSales(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_bill_of_materials':
      return await client.listBillOfMaterials(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_work_orders':
      return await client.listWorkOrders(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    case 'stateset_list_manufacturer_orders':
      return await client.listManufacturerOrders(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
    ...
    case 'stateset_list_inventories':
      return await client.listInventories(
        schemas.ListArgsSchema.parse(safeRequest.params.arguments) as any,
      );
